...
#define ALL_SYSCALLS32 \
    ...
    SYSCALL_ENTRY( 0x001b, NtConvertBetweenAuxiliaryCounterAndPerformanceCounter, 16 ) \
    ...
    SYSCALL_ENTRY( 0x00ee, __wine_dbg_ftrace, 12 ) \
    SYSCALL_ENTRY( 0x00ef, __wine_needs_override_large_address_aware, 0 ) \
    SYSCALL_ENTRY( 0x00f0, __wine_set_unix_env, 8 ) \
...
#define ALL_SYSCALLS64 \
    ...
    SYSCALL_ENTRY( 0x001b, NtConvertBetweenAuxiliaryCounterAndPerformanceCounter, 32 ) \
    ...
    SYSCALL_ENTRY( 0x00e9, __wine_dbg_ftrace, 24 ) \
    SYSCALL_ENTRY( 0x00ea, __wine_needs_override_large_address_aware, 0 ) \
    SYSCALL_ENTRY( 0x00eb, __wine_set_unix_env, 16 ) \
