...
#define ALL_SYSCALLS32 \
    ...
    SYSCALL_ENTRY( 0x00f4, NtUserGetCurrentInputMessageSource, 4 ) \
    ...
    SYSCALL_ENTRY( 0x011e, NtUserGetThreadState, 4 ) \
    SYSCALL_ENTRY( 0x011f, NtUserGetTitleBarInfo, 8 ) \
    SYSCALL_ENTRY( 0x0120, NtUserGetTouchInputInfo, 16 ) \
    ...
    SYSCALL_ENTRY( 0x0130, NtUserIsTouchWindow, 8 ) \
    SYSCALL_ENTRY( 0x0131, NtUserKillTimer, 8 ) \
    SYSCALL_ENTRY( 0x0132, NtUserLockWindowUpdate, 4 ) \
    SYSCALL_ENTRY( 0x0133, NtUserLogicalToPerMonitorDPIPhysicalPoint, 8 ) \
    SYSCALL_ENTRY( 0x0134, NtUserMapVirtualKeyEx, 12 ) \
    SYSCALL_ENTRY( 0x0135, NtUserMenuItemFromPoint, 16 ) \
    SYSCALL_ENTRY( 0x0136, NtUserMessageCall, 28 ) \
    SYSCALL_ENTRY( 0x0137, NtUserMoveWindow, 24 ) \
    SYSCALL_ENTRY( 0x0138, NtUserMsgWaitForMultipleObjectsEx, 20 ) \
    SYSCALL_ENTRY( 0x0139, NtUserNotifyIMEStatus, 8 ) \
    SYSCALL_ENTRY( 0x013a, NtUserNotifyWinEvent, 16 ) \
    SYSCALL_ENTRY( 0x013b, NtUserOpenClipboard, 8 ) \
    SYSCALL_ENTRY( 0x013c, NtUserOpenDesktop, 12 ) \
    SYSCALL_ENTRY( 0x013d, NtUserOpenInputDesktop, 12 ) \
    SYSCALL_ENTRY( 0x013e, NtUserOpenWindowStation, 8 ) \
    SYSCALL_ENTRY( 0x013f, NtUserPeekMessage, 20 ) \
    SYSCALL_ENTRY( 0x0140, NtUserPerMonitorDPIPhysicalToLogicalPoint, 8 ) \
    SYSCALL_ENTRY( 0x0141, NtUserPostMessage, 16 ) \
    SYSCALL_ENTRY( 0x0142, NtUserPostThreadMessage, 16 ) \
    SYSCALL_ENTRY( 0x0143, NtUserPrintWindow, 12 ) \
    SYSCALL_ENTRY( 0x0144, NtUserQueryDisplayConfig, 24 ) \
    SYSCALL_ENTRY( 0x0145, NtUserQueryInputContext, 8 ) \
    SYSCALL_ENTRY( 0x0146, NtUserRealChildWindowFromPoint, 12 ) \
    SYSCALL_ENTRY( 0x0147, NtUserRedrawWindow, 16 ) \
    SYSCALL_ENTRY( 0x0148, NtUserRegisterClassExWOW, 28 ) \
    SYSCALL_ENTRY( 0x0149, NtUserRegisterHotKey, 16 ) \
    SYSCALL_ENTRY( 0x014a, NtUserRegisterRawInputDevices, 12 ) \
    SYSCALL_ENTRY( 0x014b, NtUserReleaseDC, 8 ) \
    SYSCALL_ENTRY( 0x014c, NtUserRemoveClipboardFormatListener, 4 ) \
    SYSCALL_ENTRY( 0x014d, NtUserRemoveMenu, 12 ) \
    SYSCALL_ENTRY( 0x014e, NtUserRemoveProp, 8 ) \
    SYSCALL_ENTRY( 0x014f, NtUserScrollDC, 28 ) \
    SYSCALL_ENTRY( 0x0150, NtUserScrollWindowEx, 32 ) \
    SYSCALL_ENTRY( 0x0151, NtUserSelectPalette, 12 ) \
    SYSCALL_ENTRY( 0x0152, NtUserSendInput, 12 ) \
    SYSCALL_ENTRY( 0x0153, NtUserSetActiveWindow, 4 ) \
    SYSCALL_ENTRY( 0x0154, NtUserSetCapture, 4 ) \
    SYSCALL_ENTRY( 0x0155, NtUserSetClassLong, 16 ) \
    SYSCALL_ENTRY( 0x0156, NtUserSetClassLongPtr, 16 ) \
    SYSCALL_ENTRY( 0x0157, NtUserSetClassWord, 12 ) \
    SYSCALL_ENTRY( 0x0158, NtUserSetClipboardData, 12 ) \
    SYSCALL_ENTRY( 0x0159, NtUserSetClipboardViewer, 4 ) \
    SYSCALL_ENTRY( 0x015a, NtUserSetCursor, 4 ) \
    SYSCALL_ENTRY( 0x015b, NtUserSetCursorIconData, 16 ) \
    SYSCALL_ENTRY( 0x015c, NtUserSetCursorPos, 8 ) \
    SYSCALL_ENTRY( 0x015d, NtUserSetFocus, 4 ) \
    SYSCALL_ENTRY( 0x015e, NtUserSetInternalWindowPos, 16 ) \
    SYSCALL_ENTRY( 0x015f, NtUserSetKeyboardState, 4 ) \
    SYSCALL_ENTRY( 0x0160, NtUserSetLayeredWindowAttributes, 16 ) \
    SYSCALL_ENTRY( 0x0161, NtUserSetMenu, 8 ) \
    SYSCALL_ENTRY( 0x0162, NtUserSetMenuContextHelpId, 8 ) \
    SYSCALL_ENTRY( 0x0163, NtUserSetMenuDefaultItem, 12 ) \
    SYSCALL_ENTRY( 0x0164, NtUserSetObjectInformation, 16 ) \
    SYSCALL_ENTRY( 0x0165, NtUserSetParent, 8 ) \
    SYSCALL_ENTRY( 0x0166, NtUserSetProcessDpiAwarenessContext, 8 ) \
    SYSCALL_ENTRY( 0x0167, NtUserSetProcessWindowStation, 4 ) \
    SYSCALL_ENTRY( 0x0168, NtUserSetProp, 12 ) \
    SYSCALL_ENTRY( 0x0169, NtUserSetScrollInfo, 16 ) \
    SYSCALL_ENTRY( 0x016a, NtUserSetShellWindowEx, 8 ) \
    SYSCALL_ENTRY( 0x016b, NtUserSetSysColors, 12 ) \
    SYSCALL_ENTRY( 0x016c, NtUserSetSystemMenu, 8 ) \
    SYSCALL_ENTRY( 0x016d, NtUserSetSystemTimer, 12 ) \
    SYSCALL_ENTRY( 0x016e, NtUserSetThreadDesktop, 4 ) \
    SYSCALL_ENTRY( 0x016f, NtUserSetTimer, 20 ) \
    SYSCALL_ENTRY( 0x0170, NtUserSetWinEventHook, 32 ) \
    SYSCALL_ENTRY( 0x0171, NtUserSetWindowLong, 16 ) \
    SYSCALL_ENTRY( 0x0172, NtUserSetWindowLongPtr, 16 ) \
    SYSCALL_ENTRY( 0x0173, NtUserSetWindowPlacement, 8 ) \
    SYSCALL_ENTRY( 0x0174, NtUserSetWindowPos, 28 ) \
    SYSCALL_ENTRY( 0x0175, NtUserSetWindowRgn, 12 ) \
    SYSCALL_ENTRY( 0x0176, NtUserSetWindowWord, 12 ) \
    SYSCALL_ENTRY( 0x0177, NtUserSetWindowsHookEx, 24 ) \
    SYSCALL_ENTRY( 0x0178, NtUserShowCaret, 4 ) \
    SYSCALL_ENTRY( 0x0179, NtUserShowCursor, 4 ) \
    SYSCALL_ENTRY( 0x017a, NtUserShowScrollBar, 12 ) \
    SYSCALL_ENTRY( 0x017b, NtUserShowWindow, 8 ) \
    SYSCALL_ENTRY( 0x017c, NtUserShowWindowAsync, 8 ) \
    ...
    SYSCALL_ENTRY( 0x0194, __wine_send_input, 12 )
...
#define ALL_SYSCALLS64 \
    ...
    SYSCALL_ENTRY( 0x00f2, NtUserGetClipboardSequenceNumber, 0 ) \
    SYSCALL_ENTRY( 0x00f3, NtUserGetClipboardViewer, 0 ) \
    SYSCALL_ENTRY( 0x00f4, NtUserGetCurrentInputMessageSource, 8 ) \
    SYSCALL_ENTRY( 0x00f5, NtUserGetCursor, 0 ) \
    ...
    SYSCALL_ENTRY( 0x011e, NtUserGetThreadState, 8 ) \
    SYSCALL_ENTRY( 0x011f, NtUserGetTitleBarInfo, 16 ) \
    SYSCALL_ENTRY( 0x0120, NtUserGetTouchInputInfo, 32 ) \
    ...
    SYSCALL_ENTRY( 0x012f, NtUserIsMouseInPointerEnabled, 0 ) \
    SYSCALL_ENTRY( 0x0130, NtUserIsTouchWindow, 16 ) \
    SYSCALL_ENTRY( 0x0131, NtUserKillTimer, 16 ) \
    SYSCALL_ENTRY( 0x0132, NtUserLockWindowUpdate, 8 ) \
    SYSCALL_ENTRY( 0x0133, NtUserLogicalToPerMonitorDPIPhysicalPoint, 16 ) \
    SYSCALL_ENTRY( 0x0134, NtUserMapVirtualKeyEx, 24 ) \
    SYSCALL_ENTRY( 0x0135, NtUserMenuItemFromPoint, 32 ) \
    SYSCALL_ENTRY( 0x0136, NtUserMessageCall, 56 ) \
    SYSCALL_ENTRY( 0x0137, NtUserMoveWindow, 48 ) \
    SYSCALL_ENTRY( 0x0138, NtUserMsgWaitForMultipleObjectsEx, 40 ) \
    SYSCALL_ENTRY( 0x0139, NtUserNotifyIMEStatus, 16 ) \
    SYSCALL_ENTRY( 0x013a, NtUserNotifyWinEvent, 32 ) \
    SYSCALL_ENTRY( 0x013b, NtUserOpenClipboard, 16 ) \
    SYSCALL_ENTRY( 0x013c, NtUserOpenDesktop, 24 ) \
    SYSCALL_ENTRY( 0x013d, NtUserOpenInputDesktop, 24 ) \
    SYSCALL_ENTRY( 0x013e, NtUserOpenWindowStation, 16 ) \
    SYSCALL_ENTRY( 0x013f, NtUserPeekMessage, 40 ) \
    SYSCALL_ENTRY( 0x0140, NtUserPerMonitorDPIPhysicalToLogicalPoint, 16 ) \
    SYSCALL_ENTRY( 0x0141, NtUserPostMessage, 32 ) \
    SYSCALL_ENTRY( 0x0142, NtUserPostThreadMessage, 32 ) \
    SYSCALL_ENTRY( 0x0143, NtUserPrintWindow, 24 ) \
    SYSCALL_ENTRY( 0x0144, NtUserQueryDisplayConfig, 48 ) \
    SYSCALL_ENTRY( 0x0145, NtUserQueryInputContext, 16 ) \
    SYSCALL_ENTRY( 0x0146, NtUserRealChildWindowFromPoint, 24 ) \
    SYSCALL_ENTRY( 0x0147, NtUserRedrawWindow, 32 ) \
    SYSCALL_ENTRY( 0x0148, NtUserRegisterClassExWOW, 56 ) \
    SYSCALL_ENTRY( 0x0149, NtUserRegisterHotKey, 32 ) \
    SYSCALL_ENTRY( 0x014a, NtUserRegisterRawInputDevices, 24 ) \
    SYSCALL_ENTRY( 0x014b, NtUserReleaseDC, 16 ) \
    SYSCALL_ENTRY( 0x014c, NtUserRemoveClipboardFormatListener, 8 ) \
    SYSCALL_ENTRY( 0x014d, NtUserRemoveMenu, 24 ) \
    SYSCALL_ENTRY( 0x014e, NtUserRemoveProp, 16 ) \
    SYSCALL_ENTRY( 0x014f, NtUserScrollDC, 56 ) \
    SYSCALL_ENTRY( 0x0150, NtUserScrollWindowEx, 64 ) \
    SYSCALL_ENTRY( 0x0151, NtUserSelectPalette, 24 ) \
    SYSCALL_ENTRY( 0x0152, NtUserSendInput, 24 ) \
    SYSCALL_ENTRY( 0x0153, NtUserSetActiveWindow, 8 ) \
    SYSCALL_ENTRY( 0x0154, NtUserSetCapture, 8 ) \
    SYSCALL_ENTRY( 0x0155, NtUserSetClassLong, 32 ) \
    SYSCALL_ENTRY( 0x0156, NtUserSetClassLongPtr, 32 ) \
    SYSCALL_ENTRY( 0x0157, NtUserSetClassWord, 24 ) \
    SYSCALL_ENTRY( 0x0158, NtUserSetClipboardData, 24 ) \
    SYSCALL_ENTRY( 0x0159, NtUserSetClipboardViewer, 8 ) \
    SYSCALL_ENTRY( 0x015a, NtUserSetCursor, 8 ) \
    SYSCALL_ENTRY( 0x015b, NtUserSetCursorIconData, 32 ) \
    SYSCALL_ENTRY( 0x015c, NtUserSetCursorPos, 16 ) \
    SYSCALL_ENTRY( 0x015d, NtUserSetFocus, 8 ) \
    SYSCALL_ENTRY( 0x015e, NtUserSetInternalWindowPos, 32 ) \
    SYSCALL_ENTRY( 0x015f, NtUserSetKeyboardState, 8 ) \
    SYSCALL_ENTRY( 0x0160, NtUserSetLayeredWindowAttributes, 32 ) \
    SYSCALL_ENTRY( 0x0161, NtUserSetMenu, 16 ) \
    SYSCALL_ENTRY( 0x0162, NtUserSetMenuContextHelpId, 16 ) \
    SYSCALL_ENTRY( 0x0163, NtUserSetMenuDefaultItem, 24 ) \
    SYSCALL_ENTRY( 0x0164, NtUserSetObjectInformation, 32 ) \
    SYSCALL_ENTRY( 0x0165, NtUserSetParent, 16 ) \
    SYSCALL_ENTRY( 0x0166, NtUserSetProcessDpiAwarenessContext, 16 ) \
    SYSCALL_ENTRY( 0x0167, NtUserSetProcessWindowStation, 8 ) \
    SYSCALL_ENTRY( 0x0168, NtUserSetProp, 24 ) \
    SYSCALL_ENTRY( 0x0169, NtUserSetScrollInfo, 32 ) \
    SYSCALL_ENTRY( 0x016a, NtUserSetShellWindowEx, 16 ) \
    SYSCALL_ENTRY( 0x016b, NtUserSetSysColors, 24 ) \
    SYSCALL_ENTRY( 0x016c, NtUserSetSystemMenu, 16 ) \
    SYSCALL_ENTRY( 0x016d, NtUserSetSystemTimer, 24 ) \
    SYSCALL_ENTRY( 0x016e, NtUserSetThreadDesktop, 8 ) \
    SYSCALL_ENTRY( 0x016f, NtUserSetTimer, 40 ) \
    SYSCALL_ENTRY( 0x0170, NtUserSetWinEventHook, 64 ) \
    SYSCALL_ENTRY( 0x0171, NtUserSetWindowLong, 32 ) \
    SYSCALL_ENTRY( 0x0172, NtUserSetWindowLongPtr, 32 ) \
    SYSCALL_ENTRY( 0x0173, NtUserSetWindowPlacement, 16 ) \
    SYSCALL_ENTRY( 0x0174, NtUserSetWindowPos, 56 ) \
    SYSCALL_ENTRY( 0x0175, NtUserSetWindowRgn, 24 ) \
    SYSCALL_ENTRY( 0x0176, NtUserSetWindowWord, 24 ) \
    SYSCALL_ENTRY( 0x0177, NtUserSetWindowsHookEx, 48 ) \
    SYSCALL_ENTRY( 0x0178, NtUserShowCaret, 8 ) \
    SYSCALL_ENTRY( 0x0179, NtUserShowCursor, 8 ) \
    SYSCALL_ENTRY( 0x017a, NtUserShowScrollBar, 24 ) \
    SYSCALL_ENTRY( 0x017b, NtUserShowWindow, 16 ) \
    SYSCALL_ENTRY( 0x017c, NtUserShowWindowAsync, 16 ) \
    ...
    SYSCALL_ENTRY( 0x0194, __wine_send_input, 24 )
