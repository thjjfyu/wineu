...
struct vulkan_device_funcs
{
    ...
    void (*p_vkCmdBindDescriptorSets2)(VkCommandBuffer, const VkBindDescriptorSetsInfo *);
    void (*p_vkCmdBindDescriptorSets2KHR)(VkCommandBuffer, const VkBindDescriptorSetsInfo *);
    void (*p_vkCmdBindIndexBuffer)(VkCommandBuffer, VkBuffer, VkDeviceSize, VkIndexType);
    void (*p_vkCmdBindIndexBuffer2)(VkCommandBuffer, VkBuffer, VkDeviceSize, VkDeviceSize, VkIndexType);
    ...
    void (*p_vkCmdPushConstants2)(VkCommandBuffer, const VkPushConstantsInfo *);
    void (*p_vkCmdPushConstants2KHR)(VkCommandBuffer, const VkPushConstantsInfo *);
    void (*p_vkCmdPushDescriptorSet)(VkCommandBuffer, VkPipelineBindPoint, VkPipelineLayout, uint32_t, uint32_t, const VkWriteDescriptorSet *);
    void (*p_vkCmdPushDescriptorSet2)(VkCommandBuffer, const VkPushDescriptorSetInfo *);
    void (*p_vkCmdPushDescriptorSet2KHR)(VkCommandBuffer, const VkPushDescriptorSetInfo *);
    ...
    void (*p_vkCmdPushDescriptorSetWithTemplate)(VkCommandBuffer, VkDescriptorUpdateTemplate, VkPipelineLayout, uint32_t, const void *);
    void (*p_vkCmdPushDescriptorSetWithTemplate2)(VkCommandBuffer, const VkPushDescriptorSetWithTemplateInfo *);
    void (*p_vkCmdPushDescriptorSetWithTemplate2KHR)(VkCommandBuffer, const VkPushDescriptorSetWithTemplateInfo *);
    ...
    void (*p_vkCmdSetLineStipple)(VkCommandBuffer, uint32_t, uint16_t);
    ...
    void (*p_vkCmdSetRenderingAttachmentLocations)(VkCommandBuffer, const VkRenderingAttachmentLocationInfo *);
    void (*p_vkCmdSetRenderingAttachmentLocationsKHR)(VkCommandBuffer, const VkRenderingAttachmentLocationInfo *);
    void (*p_vkCmdSetRenderingInputAttachmentIndices)(VkCommandBuffer, const VkRenderingInputAttachmentIndexInfo *);
    void (*p_vkCmdSetRenderingInputAttachmentIndicesKHR)(VkCommandBuffer, const VkRenderingInputAttachmentIndexInfo *);
    ...
    VkResult (*p_vkCopyImageToImage)(VkDevice, const VkCopyImageToImageInfo *);
    VkResult (*p_vkCopyImageToImageEXT)(VkDevice, const VkCopyImageToImageInfo *);
    VkResult (*p_vkCopyImageToMemory)(VkDevice, const VkCopyImageToMemoryInfo *);
    VkResult (*p_vkCopyImageToMemoryEXT)(VkDevice, const VkCopyImageToMemoryInfo *);
    ...
    VkResult (*p_vkCopyMemoryToImage)(VkDevice, const VkCopyMemoryToImageInfo *);
    VkResult (*p_vkCopyMemoryToImageEXT)(VkDevice, const VkCopyMemoryToImageInfo *);
    ...
    void (*p_vkGetDeviceImageSubresourceLayout)(VkDevice, const VkDeviceImageSubresourceInfo *, VkSubresourceLayout2 *);
    void (*p_vkGetDeviceImageSubresourceLayoutKHR)(VkDevice, const VkDeviceImageSubresourceInfo *, VkSubresourceLayout2 *);
    ...
    void (*p_vkGetImageSubresourceLayout2)(VkDevice, VkImage, const VkImageSubresource2 *, VkSubresourceLayout2 *);
    void (*p_vkGetImageSubresourceLayout2EXT)(VkDevice, VkImage, const VkImageSubresource2 *, VkSubresourceLayout2 *);
    void (*p_vkGetImageSubresourceLayout2KHR)(VkDevice, VkImage, const VkImageSubresource2 *, VkSubresourceLayout2 *);
    ...
    void (*p_vkGetRenderingAreaGranularity)(VkDevice, const VkRenderingAreaInfo *, VkExtent2D *);
    void (*p_vkGetRenderingAreaGranularityKHR)(VkDevice, const VkRenderingAreaInfo *, VkExtent2D *);
    ...
    VkResult (*p_vkMapMemory2)(VkDevice, const VkMemoryMapInfo *, void **);
    VkResult (*p_vkMapMemory2KHR)(VkDevice, const VkMemoryMapInfo *, void **);
    ...
    VkResult (*p_vkTransitionImageLayout)(VkDevice, uint32_t, const VkHostImageLayoutTransitionInfo *);
    VkResult (*p_vkTransitionImageLayoutEXT)(VkDevice, uint32_t, const VkHostImageLayoutTransitionInfo *);
    ...
    VkResult (*p_vkUnmapMemory2)(VkDevice, const VkMemoryUnmapInfo *);
    VkResult (*p_vkUnmapMemory2KHR)(VkDevice, const VkMemoryUnmapInfo *);
